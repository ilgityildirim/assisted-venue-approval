...
func (u *SQLUnitOfWork) GetManualReviewVenuesCtx(ctx context.Context, search string, minScore int, limit int, offset int) ([]models.VenueWithUser, []int, int, error) {
	return u.db.GetManualReviewVenuesCtx(ctx, search, minScore, limit, offset)
}
